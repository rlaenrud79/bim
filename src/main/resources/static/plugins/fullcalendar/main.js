...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var CalendarApi = /** @class */ (function () {
        ...
        CalendarApi.prototype.add = function () {
            this.unselect();
            this.dispatch({
                type: 'Add',
            });
    ...
    */
    ...
    function buildViewSpec(viewDef, overrideConfigs, optionOverrides, dynamicOptionOverrides, localeDefaults) {
        ...
        var queryButtonText = function (optionsSubset) {
            ...
            // console.log("buttonTextMap", buttonTextMap);
            // console.log("buttonTextKey", buttonTextKey);
        ...
        //console.log("localeDefaults", localeDefaults);
        return {
            type: viewDef.type,
    ...
    function parseSection(sectionStr, calendarOptions, calendarOptionOverrides, theme, viewSpecs, calendarApi, viewsWithButtons) {
        ...
        return sectionSubstrs.map(function (buttonGroupStr) { return (buttonGroupStr.split(',').map(function (buttonName) {
            ...
            if ((customButtonProps = calendarCustomButtons[buttonName])) {
                ...
                // console.log("theme.getIconClass(buttonName, isRtl)", theme.getIconClass(buttonName, isRtl));
                // console.log("onProps.text", onProps.text);
                //
                ...
                //
                // console.log("b");
                // console.log("viewSpec.buttonTextOverride", viewSpec.buttonTextOverride);
                // console.log("ctheme.getIconClass(buttonName, isRtl)", theme.getIconClass(buttonName, isRtl));
                // console.log("viewSpec.buttonTextDefault)", viewSpec.buttonTextDefault);
                //
                // console.log("buttonIcon", buttonIcon);
                // console.log("buttonName", buttonName);
                // console.log("buttonText", buttonText);
                ...
                // console.log("c");
                //
                // console.log("calendarButtonTextOverrides", calendarButtonTextOverrides);
                // console.log("calendarButtonText", calendarButtonText);
                //
                // console.log("calendarButtonTextOverrides[buttonName]", calendarButtonTextOverrides[buttonName]);
                // console.log("calendarButtonText[buttonName]", calendarButtonText[buttonName]);
                //
                // console.log("buttonIcon", buttonIcon);
                // console.log("buttonName", buttonName);
                // console.log("buttonText", buttonText);
    ...
    */
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype._computeOptionsData = function (optionOverrides, dynamicOptionOverrides, calendarApi) {
            ...
            //console.log('_a.refiledOptions', _a.refinedOptions);
        ...
        CalendarDataManager.prototype.processRawCalendarOptions = function (optionOverrides, dynamicOptionOverrides) {
            ...
            // console.log("this.currentCalendarOptionsInput", this.currentCalendarOptionsInput);
            // console.log("this.currentCalendarOptionsRefined", this.currentCalendarOptionsRefined);
    ...
    */
    ...
    function getSegAnchorAttrs(seg) {
        ...
        var dataId = seg.eventRange.def.publicId;
        var dataIsOwner = seg.eventRange.def.extendedProps.isOwner;

        // console.log('seg.eventRange.def', seg.eventRange.def);
        // console.log('seg.eventRange', seg.eventRange);
        // console.log('seg', seg);

        if(url != '' && dataId !='') return { href : url, 'data-id' : dataId, 'data-owner' : dataIsOwner};
        if(url == '' && dataId !='') return { 'data-id' : dataId, 'data-owner' : dataIsOwner};
        if(url != '' && dataId =='') return { href : url, 'data-owner' : dataIsOwner};
        return {};
    }
        ...
        TableCellTop.prototype.render = function () {
            ...
            return (
              ...
              , function (innerElRef, innerContent) {
                ...
                return ((innerContent || props.forceDayTop) && (createElement("div", { className: "fc-daygrid-day-top", ref: innerElRef }, createElement("a", __assign({ className: "fc-daygrid-day-number" }, navLinkAttrs), innerContent || createElement(Fragment, null, "\u00A0"))))); }));
        };
        return TableCellTop;
    }(BaseComponent));
