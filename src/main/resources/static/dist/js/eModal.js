    ...
    define(['jquery'], function ($, root) {
        ...
        function _getFooter(buttons) {
            ...
            if (buttons) {
                for (var i = 0, k = buttons.length; i < k; i++) {
                    var btnOp = buttons[i];
                    var btn = $('<button>').addClass('btn btn-' + (btnOp.style || 'success'));
                ...
                messageFotter.append('<button class="x btn btn-success" data-dismiss=modal type=button>Close</button>');
            }
        ...
        function _getModalInstance(skipEventChageIfExists) {
            ...
            function createModalElement() {
                return $('<div class="modal fade alert-modal" tabindex="-1">' +
