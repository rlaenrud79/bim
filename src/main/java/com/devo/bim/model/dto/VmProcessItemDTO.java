...
public class VmProcessItemDTO {
    ...
    private VmProcessItemDTO.ProcessItemCostOrigin originData;
    ...
    private long gisungProcessItemId = 0;


    public VmProcessItemDTO(VmProcessItem processItem) {
        ...
        this.title = Utils.isEmpty(title, "");
        ...
        this.originData = new VmProcessItemDTO.ProcessItemCostOrigin(processItem);
    ...
    public VmProcessItemDTO(VmProcessItem processItem
        ...
        this.cate5 = processItem.getCate5();
        this.cate6 = processItem.getCate6();
        this.cate1Name = processItem.getCate1Name();
        this.cate2Name = processItem.getCate2Name();
        this.cate3Name = processItem.getCate3Name();
        this.cate4Name = processItem.getCate4Name();
        this.cate5Name = processItem.getCate5Name();
    ...
    public VmProcessItemDTO(VmProcessItem processItem
        ...
        this.cate5Name = processItem.getCate5Name();
        this.cateProgressRate = cateProgressRate;
        this.gisungProcessItemId = gisungProcessItemId;
    }
    ...
    private class ProcessItemCostOrigin {
        ...
        public ProcessItemCostOrigin(VmProcessItem processItem) {
    ...
    public VmProcessItemDTO(String cate1
            , String cate2
            , String cate3
            , String cate4
            , String cate5
