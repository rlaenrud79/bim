...
@Data
public class JobSheetProcessItemCostDTO {
    private long id;
    ...
    public JobSheetProcessItemCostDTO(String phasingCode, String taskName, String taskFullPath, Integer rowNum, Integer parentRowNum,
